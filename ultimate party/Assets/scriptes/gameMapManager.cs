...
public class gameMapManager : MonoBehaviour
{
    ...
    [SerializeField] private Transform centerMenuChoise = null;
    ...
    public void Start()
    {
        ...
        if(centerMenuChoise != null)
        {
            for (int i = 0; i < 7; i++)
            {
                if (i < 4)
                {
                    menuBuiderStartPositions[i] = new Vector3(centerMenuChoise.transform.position.x - 5.25f + i * 3.5f, centerMenuChoise.transform.position.y, 0);
                }
                else
                {
                    menuBuiderStartPositions[i] = new Vector3(centerMenuChoise.transform.position.x - 3.5f + (i - 4) * 3.5f, centerMenuChoise.transform.position.y, 0);
                }
            }
        }
    ...
    public void startBuilding()
    {
        ...
        for (int i = 0; i < players.Length; i++)
        {
            if(players.Length == 1)
            {
                players[i].menuBuilderPlayer.transform.position = menuBuiderStartPositions[3];
            }
    ...
    public void win(int indexWinPlayer)
    {
        ...
        camLvlPlayers.transform.position = new Vector2(finish.position.x - 3, finish.position.y);
